...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SOLVICE_VRP_SOLVER_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SOLVICE_VRP_SOLVER_LOG'] or 'warn' if it isn't set.
   */
...
export class SolviceVrpSolver {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? SolviceVrpSolver.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SOLVICE_VRP_SOLVER_LOG'), "process.env['SOLVICE_VRP_SOLVER_LOG']", this) ??
      defaultLogLevel;
  ...
  static SolviceVrpSolver = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static SolviceVrpSolverError = Errors.SolviceVrpSolverError;
