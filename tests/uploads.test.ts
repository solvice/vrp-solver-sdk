import fs from 'fs';
import type { ResponseLike } from 'solvice-vrp-solver/internal/to-file';
import { toFile } from 'solvice-vrp-solver/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('solvice-vrp-solver/core/uploads');
    await expect(
