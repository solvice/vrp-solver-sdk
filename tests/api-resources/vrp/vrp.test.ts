...
describe('resource vrp', () => {
  ...
  test.skip('evaluate: required and optional params', async () => {
    const response = await client.vrp.evaluate({
      jobs: [
        {
          ...
          load: [5, 10],
          location: { h3Index: 617700169958293500, latitude: 51.0543, longitude: 3.7174 },
          padding: 300,
          plannedArrival: '2023-01-13T09:00:00Z',
          plannedDate: '2023-01-13',
          plannedResource: 'vehicle-1',
          priority: 100,
          proficiency: [{ resource: 'senior-technician', durationModifier: 0.8 }],
      ...
      resources: [
        {
          ...
          shifts: [
            {
              ...
              end: { h3Index: 617700169958293500, latitude: 51.0543, longitude: 3.7174 },
              ...
              start: { h3Index: 617700169958293500, latitude: 51.0543, longitude: 3.7174 },
          ...
          end: { h3Index: 617700169958293500, latitude: 50.0987624, longitude: 4.93849204 },
          hourlyCost: 25,
          maxDriveDistance: 0,
          maxDriveTime: 0,
          maxDriveTimeInSeconds: 28800,
          maxDriveTimeJob: 7200,
          region: { h3Index: 617700169958293500, latitude: 51.05, longitude: 3.72 },
          rules: [
            {
          ...
          start: { h3Index: 617700169958293500, latitude: 50.0987624, longitude: 4.93849204 },
      ...
      label: 'label',
      options: {
        clusteringThresholdMeters: 10000,
