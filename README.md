# Solvice Vrp Solver TypeScript API Library
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/solvice-vrp-solver-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install solvice-vrp-solver`
...
1. Via the `SOLVICE_VRP_SOLVER_LOG` environment variable
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/solvice-vrp-solver-typescript/issues) with questions, bugs, or suggestions.
